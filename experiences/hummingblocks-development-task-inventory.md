...
| HB-27 | 2024.08 | 디자이너의 Figma 시안을 기준으로 좌표·비율을 계산해 Main/Select/Play/Loading·다이얼로그를 360×740 percentage Guideline·auto-size 기반 Android UI로 구현 | `e5c69ad`, `65ee77b` | A(구현) / 디자인 원안은 디자이너 | 높음 |
